...
\begin{tcolorbox}[enhanced jigsaw, breakable, toprule=.15mm, colframe=quarto-callout-tip-color-frame, colbacktitle=quarto-callout-tip-color!10!white, titlerule=0mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Pista}, leftrule=.75mm, opacityback=0, colback=white, bottomtitle=1mm, toptitle=1mm, left=2mm, arc=.35mm, rightrule=.15mm, bottomrule=.15mm, opacitybacktitle=0.6, coltitle=black]
